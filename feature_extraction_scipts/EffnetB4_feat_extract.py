...
for pt in ["val"]:
  ...
  def load_image(image_path):
      ...
      img = tf.keras.layers.Resizing(380, 380)(img)
      img = tf.keras.applications.efficientnet.preprocess_input(img)
      return img, image_path

  image_model = tf.keras.applications.efficientnet.EfficientNetB4()
